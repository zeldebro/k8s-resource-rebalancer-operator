...
import (
	...
	"github.com/zeldebro/k8s-resource-rebalancer-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(smartv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "98d48548.smart.dev",
